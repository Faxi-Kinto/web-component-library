...
export const CountryCodes: CountryCode[] = [
  ...
  { name: 'United Kingdom', dialCode: '+44', code: 'UK' },
  ...
  { name: 'Antarctica', dialCode: '', code: 'AQ' },
...
export const countryOptions = CountryCodes.sort((elem1, elem2) =>
  elem1.name < elem2.name ? -1 : 1
).map(elem => {
  return { label: elem.name, value: elem.code };
});
