    ...
    {() => {
      ...
      <div>
       ...
       <Modal
        ...
        body="Your community has been successfully registered. A verification link has been sent to your email account. Please verify your email in order to access the created community."
